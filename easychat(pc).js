...
$("#o2-5").css({"display":"none"});
$("body").css({"font-family":' "Helvetica Neue",Helvetica,"PingFang SC","Hiragino Sans GB",STHeiti,"Microsoft Yahei","WenQuanYi Micro Hei",Arial,Verdana,sans-serif'});	
});
